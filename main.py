...
ticker = input("Enter your stock ticker: ").upper()
from_date = input("Enter your start date in yyyy/mm/dd format: ")
to_date = input("Enter your end date in yyyy/mm/dd format: ")
